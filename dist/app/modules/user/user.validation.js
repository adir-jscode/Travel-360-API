...
exports.giveReviewZodSchema = exports.giveRatingZodSchema = exports.updateUserZodSchema = exports.createUserZodSchema = void 0;
...
exports.updateUserZodSchema = zod_1.default.object({
    ...
    bio: zod_1.default.string({ error: "Bio must be string" }).optional(),
    travelInterest: zod_1.default
        .array(zod_1.default.string({ error: "Each interest must be a valid string" }))
...
exports.giveRatingZodSchema = zod_1.default.object({
    value: zod_1.default
        .int("Value must be a positive number")
        .min(1, { message: "Rating value must be 1" })
        .max(5, { message: "Rating can't be bigger than 5" }),
});
exports.giveReviewZodSchema = zod_1.default.object({
    description: zod_1.default.string({ error: "Description must be string" }),
});
