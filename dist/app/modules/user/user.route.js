...
router.get("/profile/:id", (0, checkAuth_1.checkAuth)(user_interface_1.Role.USER), user_controller_1.UserControllers.getUserProfile);
...
router.patch("/profile", (0, validateRequest_1.validateRequest)(user_validation_1.updateUserZodSchema), (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), user_controller_1.UserControllers.updateUser);
/* Post-trip */
