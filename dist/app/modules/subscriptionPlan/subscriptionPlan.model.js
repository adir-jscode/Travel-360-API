...
const subscriptionPlanSchema = new mongoose_1.default.Schema({
    name: {
        type: String,
        enum: Object.values(subscriptionPlan_interface_1.SUBSCRIPTION_PLAN),
        default: subscriptionPlan_interface_1.SUBSCRIPTION_PLAN.EXPLORER,
        required: true,
        unique: true,
    },
    title: {
    ...
    duration: {
        type: String,
        enum: Object.values(subscriptionPlan_interface_1.SUBSCRIPTION_DURATION),
        required: true,
    },
    features: {
        type: [String],
